...
TGeoVolume* makeWorldSphere( TGeoManager *geoManager, double world_size ){
  TGeoVolume *world_sphere;
  ...
  world_sphere = geoManager->MakeSphere("world_sphere","vacuum",world_size);
  return world_sphere;
}
